...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "TweedeZitDevProgRobbeSaelens.Android.dll" comes first in this list. */
		"TweedeZitDevProgRobbeSaelens.Android.dll",
		"FormsViewGroup.dll",
		"Newtonsoft.Json.dll",
		"RestSharp.dll",
		"TweedeZitDevProgRobbeSaelens.dll",
